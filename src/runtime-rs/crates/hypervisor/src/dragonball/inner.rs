...
use crate::{
    device::DeviceConfig, hypervisor_persist::HypervisorState, kernel_param::KernelParams,
    VmmState, HYPERVISOR_DRAGONBALL,
};
use anyhow::{anyhow, Context, Result};
use async_trait::async_trait;
use dragonball::{api::v1::BootSourceConfig, vm::VmConfigInfo};
...
impl DragonballInner {
    ...
    pub(crate) async fn cold_start_vm(
        &mut self,
        ...
        kernel_params.append(&mut rootfs_params.clone());
